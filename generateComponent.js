...
// Дефолтный путь создания компонента: *root_directory*/packages/frontend/src/
...
(async () => {
    ...
    const componentDir = path.join(__dirname, "packages/frontend/src/", componentPath, componentName);
